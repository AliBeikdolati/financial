                ...
                <div className="container">
                    <div className="row">
                        <div className="col text-center mb-5 client__logo">
                            <img src={AlterSport} className='img-fluid client__image' alt="Alter sport" />
                        </div>
                        <div className="col text-center mb-5 client__logo">
                            <img src={CleaningService} className='img-fluid client__image' alt="Cleaning service" />
                        </div>
                        <div className="col text-center mb-5 client__logo">
                            <img src={CreativePhoto} className='img-fluid client__image' alt="Creative" />
                        </div>
                        <div className="col text-center mb-5 client__logo">
                            <img src={SpaBeauty} className='img-fluid client__image' alt="Spa beauty" />
                        </div>
                    </div>
                </div>
            </div>
